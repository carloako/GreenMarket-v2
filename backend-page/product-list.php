...
if (!$conn) {
    ...
    $sql = "SELECT id, name, price, onsale, onsale_price, product_type FROM Products";
    $result = mysqli_query($conn, $sql);
    echo '<div class="m-4 p-4 border border-4 rounded-3 bg-white">' . "\n";
    echo "<a href=\"backend-add-product.php\" class=\"btn mb-2\">Add Product</a>";
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<div class=\"col-1\"><a class=\"fa-solid fa-pencil fa-xl\" href=\"backend-edit-product.php?productID=$productID\"></a></div>\n";
            echo "<div class=\"col-1\"><a class=\"fa-solid fa-trash-can fa-xl\" href=\"backend-edit-product-form.php?productID=$productID\"></a></div>\n";
            echo '</div>' . "\n";
        }
    }
    echo '</div>' . "\n";
