...
<body>
    ...
    <div class="w-50 border border-3 rounded-2 mx-auto mt-3 p-3 bg-white">
        <form class="row g-3 needs-validation" action="add-product.php" method="get">
            <div class="col-3">
            ...
            <div class="col-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="decimalPrice" name="decimalPrice" maxlength="2" required>
                </div>
            </div>
            <div class="col-6">
            ...
            <div class="col-3">
                <input class="form-check-input" type="checkbox" id="onsale" name="onsale" value="" onchange="changeOnsaleBox(this)">
            ...
            <div class="col-3">
                ...
                <div class="input-group">
                    ...
                    <span class="input-group-text">.</span>
                    <input type="text" class="form-control" id="decimalOnsalePrice" name="decimalOnsalePrice" maxlength="2" readonly>
                </div>
            </div>
            <div class="col-6">
            </div>
